                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" class="w-4 h-4 mr-2" wire:model.live="featured" value="1" id="featured">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live="price_range"
                                ...
                                max="100000000" value="50000000" step="10000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-md font-bold text-blue-400 ">{{ Number::currency(1000, 'IDR') }}</span>
                                <span class="inline-block text-md font-bold text-blue-400 ">{{ Number::currency(100000000, 'IDR') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
